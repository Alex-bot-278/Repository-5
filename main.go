...
func (s ParcelService) Register(client int, address string) (Parcel, error) {
	...
	if err != nil {
		return Parcel{}, fmt.Errorf("failed to register parcel: %w", err)
	}
...
func (s ParcelService) PrintClientParcels(client int) error {
	...
	if err != nil {
		return fmt.Errorf("failed to get client parcels: %w", err)
	}
...
func (s ParcelService) NextStatus(number int) error {
	...
	case ParcelStatusDelivered:
		return nil
	default:
		return fmt.Errorf("unknown parcel status: %s", parcel.Status)
	}
